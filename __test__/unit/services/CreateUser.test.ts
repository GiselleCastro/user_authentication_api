...
const makeSut = () => {
  ...
  const sut = new CreateUserService(userRepositoryStub, sendEmailConfirmEmailServiceStub);
...
describe('CreateUserService', () => {
  it('User created successfully', async () => {
    ...
    sendEmailConfirmEmailServiceStub.execute.mockImplementationOnce(async () => {});
  ...
  it('should return bad request error if user is already registered', async () => {
    ...
    userRepositoryStub.getUserByUsernameOrEmail.mockImplementationOnce(async () => ({
    ...
    expect(userRepositoryStub.getUserByUsernameOrEmail(usernameMock, emailMock));
